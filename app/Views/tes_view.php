...
<div class="form-row">
  <div class="form-group col-md-6">
    ...
    <select class="form-control-plaintext" readonly="" id="pendidikan" name="pendidikan_terakhir">
      <option value="" selected disabled hidden>Pilih Pendidikan Terakhir</option>
      <option value="SD" <?= ($listKredit['pendidikan_terakhir'] == 'SD') ? 'selected' : '' ?>>SD</option>
      <option value="SMP" <?= ($listKredit['pendidikan_terakhir'] == 'SMP') ? 'selected' : '' ?>>SMP</option>
      <option value="SMA/SMK" <?= ($listKredit['pendidikan_terakhir'] == 'SMA/SMK') ? 'selected' : '' ?>>SMA/SMK</option>
      <option value="Diploma" <?= ($listKredit['pendidikan_terakhir'] == 'Diploma') ? 'selected' : '' ?>>Diploma</option>
      <option value="Sarjana" <?= ($listKredit['pendidikan_terakhir'] == 'Sarjana') ? 'selected' : '' ?>>Sarjana</option>
      <option value="Magister" <?= ($listKredit['pendidikan_terakhir'] == 'Magister') ? 'selected' : '' ?>>Magister</option>
      <option value="Doktor" <?= ($listKredit['pendidikan_terakhir'] == 'Doktor') ? 'selected' : '' ?>>Doktor</option>
    </select>
    <div class="invalid-feedback">
  ...
  <div class="form-group col-md-6">
    ...
    <input type="date" class="form-control-plaintext" readonly="" id="tahun_lulus" value="<?= $listKredit['tahun_lulus'] ?? '' ?>">
    <div class="invalid-feedback">
